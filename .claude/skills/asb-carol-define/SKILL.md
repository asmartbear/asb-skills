...
`STRENGTHS-WEAKNESSES.md`, `KEYSTONES.md`, `DEALBREAKERS.md`,
`INCITING-EVENTS.md`). The minimum viable input is a keystones file
...
*Observations* / `asb-carol-observations`) and offer only a
...
the handoff: this file is the *input* to what follows — positioning
...
`asb-interview-goals`, if installed) is the systematic way to test
