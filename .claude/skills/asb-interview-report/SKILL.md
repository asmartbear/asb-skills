...
1. **The working files:** the hypothesis list (with its watch section
...
2. **The debriefs:** the directory of per-interview files. These are
   ...
   built inline.
3. **Synthesis state:** check the hypothesis file's change log for
   ...
   *Learning* / `asb-interview-learning`, if installed), and proceed
   as a snapshot if the user prefers.
4. **Scope:** note the as-of state — how many debriefs, what date
