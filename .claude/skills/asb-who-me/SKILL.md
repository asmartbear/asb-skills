...
# Who, Me? — Find Out Who You Actually Are

"Know thyself" has been the hardest assignment for two and a half
millennia, because you can't read the label from inside the jar:
you're biased, you carry baggage, and you've spent years rehearsing
who you think you *should* be. Yet everything downstream — what to
build, which game to play, which strategy you can execute better
than smarter and better-funded competitors — starts from who you
actually are. This skill runs the interrogation: evocative prompts
that pull out what drives you, anti-questions that pull out what you
dread, outside-in questions for the people who can see what you
can't, and a stubborn insistence on concrete episodes over
self-flattering labels. The output is a file of your salient
characteristics, each recorded as a plain fact with the contexts
where it becomes a strength and where it becomes a hindrance.

## The mental model

### Characteristics are facts, not virtues

"Competitive" — always wanting to win, specifically to beat other
...
1. **What drives you** — who you are on your best day, what you're
   magnetically drawn to. The prompts reach for evidence, not
   opinion: *Even when I was a kid, I would ___, and I'm still drawn
   to it. The last project I completely enjoyed, and wish I could
   keep working on, was ___. Even on vacation, I can't help it; I
   still ___. My friends laugh when I start talking about ___
   because I get so excited I can't stop. Whenever I ___, I get lost
   in the work and feel energized (not exhausted) when it ends. If I
   could go (back) to college, I'd get a degree in ___. I was
   surprised how much my peers praised my work when I ___ — maybe
   I'm better at that than I thought. I just love doing ___; I can't
   justify it, can't explain it, but there it is. My ten-years-ago
   self would be surprised that lately I love it whenever ___. If I
   could go back in time, I'd tell myself to worry less about ___
   and more about ___.*
2. **What hinders you** — the anti-questions. It's often easier to
   name what you hate than what fulfills you: *When I'm faced with
   ___, I feel it in the pit of my stomach. The last time I had to
   ___, I did an embarrassingly minimal job because I couldn't bring
   myself to do better. I have an intense dread of any meeting where
   we ___. If my job required ___ with even 10% of my time, I'd
   think about changing jobs. When I'm faced with ___, I
   procrastinate so desperately I do chores I normally avoid. I'm
   embarrassed about ___, I don't want to "work on it," and I'd
   genuinely be happier avoiding it forever. Honestly, though I'd
   love to be great at ___, I'm never going to be good at it.
   Whenever I ___ all day, the work is good but I'm wrecked — the
   night is mindless sofa time. I know I'm supposed to like ___, but
   I never get excited about it.*
3. **Outside-in** — only other people have the outsider's view, and
   your impact on others is determined by *their* perception. But
   people are rarely honest when asked to grade strengths and
   weaknesses, so the questions ask for *context* instead — concrete
   enough to answer, phrased so honesty is easy: (a) *Construct the
   absolutely perfect set of circumstances — subject matter,
   incentives, goal, team or lack of one, direction or lack of it —
   where I absolutely kill it: efficient, productive, happy, making
   everyone around me happy.* (b) *What's my personal hell?
   Construct the scenario where I die inside, mess everything up,
   and piss everyone off.* (It's funny to ask and easy to answer —
...
The answers must be honest even when "society" wouldn't approve.
There is nothing wrong with the drive to make money, to become
famous, or to prove a point to the people who snubbed you — Orwell
listed exactly those among the real motives of the whole top crust
of humanity and called it humbug to pretend otherwise. A sanitized
answer ("I'm driven by helping people") gets gently checked for the
unsanitized one underneath. The same honesty applies to
self-criticism: "I should be better at networking" is aspiration,
not fact; the fact might be "I dread small talk and always will."

### Episodes over labels

Self-assigned trait labels are unreliable; remembered episodes are
evidence. Every claimed characteristic — flattering or damning —
...
- **Label without episode:** "You said you're a natural teacher —
  tell me the last time. What exactly did you do? Who said what?"
  No episode after honest digging = not recorded.
- **Sanitized motive:** "That's the version for the awards dinner.
  What's the version you'd only admit to yourself at 4 a.m.?"
- **Aspiration dressed as fact:** "Is that who you are, or who you
  wish you were? What does the record of the last five years say?"
- **Generic phrasing:** "I like building things" — building what?
  software, teams, furniture, audiences? The recorded fact must be
  specific enough that its strength-contexts and hindrance-contexts
...
Before finalizing, attack the draft once. If a devil's-advocate
interrogation skill is installed in the environment (for example
*Rude Q&A* / `asb-rude-qa`, from the same author as this method),
invoke it against the draft file with this brief: *attack this
...
The wielder cannot interview the user's friends, so the outside-in
questions become homework: pick 2–5 people who know the user well
(a spouse or old friend, a long-time colleague, a former boss or
...
**M1.** <The fact, specific and unsanitized.>
    Evidence: <the episodes — dated, concrete>.
    Expresses as strength when: <contexts>.
    Expresses as hindrance when: <contexts>.
...
**M7.** <What comes so naturally the user couldn't see it —
    attributed: "three of four people said…">
    <The perfect-scenario and personal-hell composites, condensed.>

## Tensions

- M2 vs M5: <the contradiction and what the user decided it means;
  for an outside-in dissent, both readings, flagged, unresolved.>

## Outside-in homework (removed at finalization; respondents then
credited in The edge intro)

Asked: <who, contexts> on <when>. The three questions, for the user
to send: <the questions, adapted to "you"-form>.

## Next steps

<Two or three sentences of prose: this file is the raw material for
strategy in the shape of you — the next step distills it to the one
or two decisive traits (the voters) that a product, positioning, and
company can be built around. Name the voters skill if installed.>
```

M-numbers are stable once written — the distillation step cites
them. Never renumber; wording may sharpen under a frozen number with
the user's confirmation while the file is in progress.
